...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Int) "ifFun5Call2" []

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: ifFun5Call2

3. (visitNode -> Entry -> method with no args): Returning: ()

4. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "ifFun5Call2",SMethodType Int)], pc = []})
...
95. (visitExpr -> FunCallExpr -> inheriting global vars varnames): Modifying State: (VarNames,fromList [(VarName "y",SymInt (-10))])
...
141. actual: ifFun5 ==> (visitSymExpr -> SBin): Returning: ER_Expr (SBool False)

142. actual: ifFun5 ==> (visitSymExpr -> SIte -> resolved condition is False -> no else body): State Not Modified

143. actual: ifFun5 ==> Next symExpr (Return ==> SymUnknown (Int,"y",Just (SymVar Int "n")) [([(If,SR {branchStart = 2, branchEnd = 4})],3)]) in Method Call: ifFun5

144. actual: ifFun5 ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

145. actual: ifFun5 ==> (visitSymExpr -> SymUnknown): handling SymExpr: SymUnknown (Int,"y",Just (SymVar Int "n")) [([(If,SR {branchStart = 2, branchEnd = 4})],3)]

146. actual: ifFun5 ==> (visitSymExpr -> SymUnknown): Modifying State: (Return,SymUnknown (Int,"y",Just (SymVar Int "n")) [([(If,SR {branchStart = 2, branchEnd = 4})],3)])

147. actual: ifFun5 ==> (visitSymExpr0 -> SymUnknown): handling SymExpr: SymUnknown (Int,"y",Just (SymVar Int "n")) [([(If,SR {branchStart = 2, branchEnd = 4})],3)]

148. actual: ifFun5 ==> (visitSymExpr0 -> SymInt): handling SymExpr: SymInt (-10)

149. actual: ifFun5 ==> (visitSymExpr0 -> SymInt): Returning: ER_Expr (SymInt (-10))

150. actual: ifFun5 ==> (visitSymExpr0 -> SymUnknown Just): Returning: ER_Expr (SymInt (-10))

151. actual: ifFun5 ==> (visitSymExpr -> SymUnknown): Returning: ER_SymStateMapEntry {er_key = Return, er_val = SymInt (-10)}

152. Method Call actual SymState: SymState {env = fromList [(MethodName "ifFun5",SMethodType Int),(GlobalVars,SGlobalVars ["y"]),(FormalParms,SFormalParms ["n"]),(VarAssignments,SVarAssignments [("y",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("y",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 2, branchEnd = 4}})]),(VarName "n",SymInt (-10)),(VarName "y",SymInt (-10)),(Return,SymInt (-10))], pc = []}

153. (visitExpr -> FunCallExpr -> with parameters): Returning: ER_FunCall (SymState {env = fromList [(MethodName "ifFun5",SMethodType Int),(GlobalVars,SGlobalVars ["y"]),(FormalParms,SFormalParms ["n"]),(VarAssignments,SVarAssignments [("y",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("y",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 2, branchEnd = 4}})]),(VarName "n",SymInt (-10)),(VarName "y",SymInt (-10)),(Return,SymInt (-10))], pc = []})

154. (visitStmt -> ReturnStmt -> method with args): Modifying State: (return,SymInt (-10))

155. (visitStmt -> ReturnStmt): Returning: ER_FunCall (SymState {env = fromList [(MethodName "ifFun5",SMethodType Int),(GlobalVars,SGlobalVars ["y"]),(FormalParms,SFormalParms ["n"]),(VarAssignments,SVarAssignments [("y",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("y",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 2, branchEnd = 4}})]),(VarName "n",SymInt (-10)),(VarName "y",SymInt (-10)),(Return,SymInt (-10))], pc = []})

156. (visitNode -> End -> method returns): Returning: ER_FunCall (SymState {env = fromList [(MethodName "ifFun5",SMethodType Int),(GlobalVars,SGlobalVars ["y"]),(FormalParms,SFormalParms ["n"]),(VarAssignments,SVarAssignments [("y",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("y",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 2, branchEnd = 4}})]),(VarName "n",SymInt (-10)),(VarName "y",SymInt (-10)),(Return,SymInt (-10))], pc = []})
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "ifFun5Call2",SMethodType Int),(GlobalVars,SGlobalVars ["y"]),(VarName "y",SymInt (-10)),(Return,SymInt (-10))], pc = []}