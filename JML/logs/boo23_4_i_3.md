...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Int) "boo23_4_i_3" [VarExpr {varType = Just (BuiltInType Int), varObj = [], varName = "i"}]

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: boo23_4_i_3
...
13. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "boo23_4_i_3",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymVar Int "i")], pc = []})

14. Next Node: End {id = 1, parent = 0, mExpr = Just (BinOpExpr {expr1 = NumberLiteral 5.0, binOp = *, expr2 = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_i"}, funArgs = [BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}]}})}

>>>>>>>>>> visitNode <<<<<<<<<<

15. (visitNode -> End): Method End

16. (visitNode -> End -> return something): handling return expression: BinOpExpr {expr1 = NumberLiteral 5.0, binOp = *, expr2 = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_i"}, funArgs = [BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}]}}

17. (visitStmt -> ReturnStmt): handling return expression: BinOpExpr {expr1 = NumberLiteral 5.0, binOp = *, expr2 = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_i"}, funArgs = [BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}]}}

18. (visitExpr -> BinOpExpr): handling expression: BinOpExpr {expr1 = NumberLiteral 5.0, binOp = *, expr2 = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_i"}, funArgs = [BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}]}}

19. (visitExpr -> NumberLiteral): handling expression: NumberLiteral 5.0

20. (visitExpr -> NumberLiteral): Returning: ER_Expr (SymNum 5.0)

21. (visitExpr -> FunCallExpr): handling expression: FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_i"}, funArgs = [BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}]}
...
48. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr): handling expression: BinOpExpr {expr1 = BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}, binOp = +, expr2 = NumberLiteral 2.0}

49. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr): handling expression: BinOpExpr {expr1 = NumberLiteral 0.0, binOp = *, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}

50. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> NumberLiteral): handling expression: NumberLiteral 0.0

51. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> NumberLiteral): Returning: ER_Expr (SymNum 0.0)

52. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> VarExpr): handling expression: VarExpr {varType = Nothing, varObj = [], varName = "i"}

53. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> VarExpr): Look up in environmane table: (i ~~> SymVar Int "i") 

54. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> VarExpr -> Updating): Returning: ER_SymStateMapEntry {er_key = VarName "i", er_val = SymVar Int "i"}

55. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr): Affected: SymNum 0.0, *, SymVar Int "i"

56. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr -> numericCalculator): Returning: ER_Expr (SymInt 0)

57. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> NumberLiteral): handling expression: NumberLiteral 2.0

58. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> NumberLiteral): Returning: ER_Expr (SymNum 2.0)

59. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr): Affected: SymInt 0, +, SymNum 2.0

60. SymExec of actual parameter: boo21_i(0.0*i+2.0) ==> (visitExpr -> BinOpExpr -> numericCalculator): Returning: ER_Expr (SymInt 2)
...
75. actual: boo21_i ==> (visitSymExpr0 -> SymVar): Returning: ER_Expr (SymInt 2)

76. actual: boo21_i ==> (visitSymExpr -> SymVar): Modifying State: (VarName "i",SymInt 2)

77. actual: boo21_i ==> (visitSymExpr -> SymVar): Returning: ER_SymStateMapEntry {er_key = VarName "i", er_val = SymInt 2}
...
82. actual: boo21_i ==> (visitSymExpr0 -> SymVar): Returning: ER_Expr (SymInt 2)

83. actual: boo21_i ==> (visitSymExpr -> SymVar): Modifying State: (Return,SymInt 2)

84. actual: boo21_i ==> (visitSymExpr -> SymVar): Returning: ER_SymStateMapEntry {er_key = Return, er_val = SymInt 2}

85. Method Call actual SymState: SymState {env = fromList [(MethodName "boo21_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymInt 2),(Return,SymInt 2)], pc = []}

86. (visitExpr -> FunCallExpr -> with parameters): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo21_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymInt 2),(Return,SymInt 2)], pc = []})

87. (visitExpr -> BinOpExpr): Affected: SymNum 5.0, *, SymInt 2

88. (visitExpr -> BinOpExpr -> numericCalculator): Returning: ER_Expr (SymInt 10)

89. (visitStmt -> ReturnStmt -> method with args): Modifying State: (return,SymInt 10)

90. (visitStmt -> ReturnStmt): Returning: ER_Expr (SymInt 10)

91. (visitNode -> End -> method returns): Returning: ER_Expr (SymInt 10)
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "boo23_4_i_3",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymVar Int "i"),(Return,SymInt 10)], pc = []}