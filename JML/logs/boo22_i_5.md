...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Int) "boo22_i_5" [VarExpr {varType = Just (BuiltInType Int), varObj = [], varName = "i"}]

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: boo22_i_5
...
13. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "boo22_i_5",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymVar Int "i")], pc = []})

14. Next Node: End {id = 1, parent = 0, mExpr = Just (FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_3_i"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "j"}]})}

>>>>>>>>>> visitNode <<<<<<<<<<

15. (visitNode -> End): Method End

16. (visitNode -> End -> return something): handling return expression: FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_3_i"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "j"}]}

17. (visitStmt -> ReturnStmt): handling return expression: FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_3_i"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "j"}]}

18. (visitExpr -> FunCallExpr): handling expression: FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "boo21_3_i"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "j"}]}
...
68. SymExec of actual parameter: boo21_3_i(j) ==> (visitExpr -> VarExpr): handling expression: VarExpr {varType = Nothing, varObj = [], varName = "j"}

69. SymExec of actual parameter: boo21_3_i(j) ==> (visitExpr -> VarExpr): Global Variable Detected: j 

70. SymExec of actual parameter: boo21_3_i(j) ==> (visitExpr -> VarExpr): Modifying State: (j,SymVar UnknownGlobalVarSymType "j")

71. SymExec of actual parameter: boo21_3_i(j) ==> (visitExpr -> VarExpr -> Recording Global Variable): Returning: ER_SymStateMapEntry {er_key = VarName "j", er_val = SymVar UnknownGlobalVarSymType "j"}

72. actual: boo21_3_i ==> Next symExpr (MethodName "boo21_3_i" ==> SMethodType Int) in Method Call: boo21_3_i

73. actual: boo21_3_i ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

74. actual: boo21_3_i ==> (visitSymExpr -> SMethodType): handling SymExpr: SMethodType Int

75. actual: boo21_3_i ==> (visitSymExpr -> SMethodType): Modifying State: (MethodName "boo21_3_i",SMethodType Int)

76. actual: boo21_3_i ==> (visitSymExpr -> SMethodType): Returning: ER_SymStateMapEntry {er_key = MethodName "boo21_3_i", er_val = SMethodType Int}

77. actual: boo21_3_i ==> Next symExpr (FormalParms ==> SFormalParms ["i"]) in Method Call: boo21_3_i

78. actual: boo21_3_i ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

79. actual: boo21_3_i ==> (visitSymExpr -> SFormalParms): handling SymExpr: SFormalParms ["i"]

80. actual: boo21_3_i ==> (visitSymExpr -> SFormalParms): Modifying State: (FormalParms,SFormalParms ["i"])

81. actual: boo21_3_i ==> (visitSymExpr -> SFormalParms): Returning: ER_SymStateMapEntry {er_key = FormalParms, er_val = SFormalParms ["i"]}

82. actual: boo21_3_i ==> Next symExpr (VarAssignments ==> SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]) in Method Call: boo21_3_i

83. actual: boo21_3_i ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

84. actual: boo21_3_i ==> (visitSymExpr -> SVarAssignments): handling SymExpr: SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]

85. actual: boo21_3_i ==> (visitSymExpr -> SVarAssignments): Modifying State: (VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})])

86. actual: boo21_3_i ==> (visitSymExpr -> SVarAssignments): Returning: ER_SymStateMapEntry {er_key = VarAssignments, er_val = SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]}

87. actual: boo21_3_i ==> Next symExpr (VarName "i" ==> SBin (SymVar Int "i") Add (SymInt 2)) in Method Call: boo21_3_i

88. actual: boo21_3_i ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

89. actual: boo21_3_i ==> (visitSymExpr -> SBin): handling SymExpr: SBin (SymVar Int "i") Add (SymInt 2)

90. actual: boo21_3_i ==> (visitSymExpr0 -> SBin): handling SymExpr: SBin (SymVar Int "i") Add (SymInt 2)
...
91. actual: boo21_3_i ==> (visitSymExpr0 -> SymVar -> Formal Parameter): handling SymExpr: SymVar Int "i"

92. actual: boo21_3_i ==> (visitSymExpr0 -> SymVar): Returning: ER_Expr (SymVar Int "j")

93. actual: boo21_3_i ==> (visitSymExpr0 -> SymInt): handling SymExpr: SymInt 2

94. actual: boo21_3_i ==> (visitSymExpr0 -> SymInt): Returning: ER_Expr (SymInt 2)

95. actual: boo21_3_i ==> (visitSymExpr -> SBin): Returning: ER_Expr (SBin (SymVar Int "j") Add (SymInt 2))

96. actual: boo21_3_i ==> (visitSymExpr -> SBin): Modifying State: (VarName "i",SBin (SymVar Int "j") Add (SymInt 2))

97. actual: boo21_3_i ==> (visitSymExpr -> SBin): Returning: ER_SymStateMapEntry {er_key = VarName "i", er_val = SBin (SymVar Int "j") Add (SymInt 2)}

98. actual: boo21_3_i ==> Next symExpr (Return ==> SBin (SymVar Int "i") Add (SymInt 2)) in Method Call: boo21_3_i

99. actual: boo21_3_i ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

100. actual: boo21_3_i ==> (visitSymExpr -> SBin): handling SymExpr: SBin (SymVar Int "i") Add (SymInt 2)

101. actual: boo21_3_i ==> (visitSymExpr0 -> SBin): handling SymExpr: SBin (SymVar Int "i") Add (SymInt 2)

SymState {env = fromList [(MethodName "boo21_3_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "j") Add (SymInt 2))], pc = []}

102. actual: boo21_3_i ==> (visitSymExpr0 -> SymVar -> Formal Parameter): handling SymExpr: SymVar Int "i"

103. actual: boo21_3_i ==> (visitSymExpr0 -> SymVar): Returning: ER_Expr (SymVar Int "j")

104. actual: boo21_3_i ==> (visitSymExpr0 -> SymInt): handling SymExpr: SymInt 2

105. actual: boo21_3_i ==> (visitSymExpr0 -> SymInt): Returning: ER_Expr (SymInt 2)

106. actual: boo21_3_i ==> (visitSymExpr -> SBin): Returning: ER_Expr (SBin (SymVar Int "j") Add (SymInt 2))

107. actual: boo21_3_i ==> (visitSymExpr -> SBin): Modifying State: (Return,SBin (SymVar Int "j") Add (SymInt 2))

108. actual: boo21_3_i ==> (visitSymExpr -> SBin): Returning: ER_SymStateMapEntry {er_key = Return, er_val = SBin (SymVar Int "j") Add (SymInt 2)}

109. Method Call actual SymState: SymState {env = fromList [(MethodName "boo21_3_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "j") Add (SymInt 2)),(Return,SBin (SymVar Int "j") Add (SymInt 2))], pc = []}

110. (visitExpr -> FunCallExpr -> with parameters): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo21_3_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "j") Add (SymInt 2)),(Return,SBin (SymVar Int "j") Add (SymInt 2))], pc = []})

111. (visitStmt -> ReturnStmt -> method with args): Modifying State: (return,SBin (SymVar Int "j") Add (SymInt 2))

112. (visitStmt -> ReturnStmt): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo21_3_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "j") Add (SymInt 2)),(Return,SBin (SymVar Int "j") Add (SymInt 2))], pc = []})

113. (visitNode -> End -> method returns): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo21_3_i",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "j") Add (SymInt 2)),(Return,SBin (SymVar Int "j") Add (SymInt 2))], pc = []})
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "boo22_i_5",SMethodType Int),(GlobalVars,SGlobalVars ["j"]),(FormalParms,SFormalParms ["i"]),(VarName "i",SymVar Int "i"),(VarName "j",SymVar UnknownGlobalVarSymType "j"),(Return,SBin (SymVar Int "j") Add (SymInt 2))], pc = []}