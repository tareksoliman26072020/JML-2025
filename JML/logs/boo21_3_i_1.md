...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Int) "boo21_3_i_1" [VarExpr {varType = Just (BuiltInType Int), varObj = [], varName = "i"}]

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: boo21_3_i_1
...
13. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "boo21_3_i_1",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarName "i",SymVar Int "i")], pc = []})
...
36. Next Node: End {id = 2, parent = 0, mExpr = Just (BinOpExpr {expr1 = VarExpr {varType = Nothing, varObj = [], varName = "i"}, binOp = +, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}})}

>>>>>>>>>> visitNode <<<<<<<<<<

37. (visitNode -> End): Method End

38. (visitNode -> End -> return something): handling return expression: BinOpExpr {expr1 = VarExpr {varType = Nothing, varObj = [], varName = "i"}, binOp = +, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}

39. (visitStmt -> ReturnStmt): handling return expression: BinOpExpr {expr1 = VarExpr {varType = Nothing, varObj = [], varName = "i"}, binOp = +, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}

40. (visitExpr -> BinOpExpr): handling expression: BinOpExpr {expr1 = VarExpr {varType = Nothing, varObj = [], varName = "i"}, binOp = +, expr2 = VarExpr {varType = Nothing, varObj = [], varName = "i"}}

41. (visitExpr -> VarExpr): handling expression: VarExpr {varType = Nothing, varObj = [], varName = "i"}

42. (visitExpr -> VarExpr): Look up in environmane table: (i ~~> SBin (SymVar Int "i") Add (SymInt 2)) 

43. (visitExpr -> VarExpr -> Updating): Returning: ER_SymStateMapEntry {er_key = VarName "i", er_val = SBin (SymVar Int "i") Add (SymInt 2)}

44. (visitExpr -> VarExpr): handling expression: VarExpr {varType = Nothing, varObj = [], varName = "i"}

45. (visitExpr -> VarExpr): Look up in environmane table: (i ~~> SBin (SymVar Int "i") Add (SymInt 2)) 

46. (visitExpr -> VarExpr -> Updating): Returning: ER_SymStateMapEntry {er_key = VarName "i", er_val = SBin (SymVar Int "i") Add (SymInt 2)}

47. (visitExpr -> BinOpExpr): Affected: SBin (SymVar Int "i") Add (SymInt 2), +, SBin (SymVar Int "i") Add (SymInt 2)

48. (visitExpr -> BinOpExpr -> numericCalculator): Returning: ER_Expr (SBin (SBin (SymInt 2) Mul (SymVar Int "i")) Add (SymInt 4))

49. (visitStmt -> ReturnStmt -> method with args): Modifying State: (return,SBin (SBin (SymInt 2) Mul (SymVar Int "i")) Add (SymInt 4))

50. (visitStmt -> ReturnStmt): Returning: ER_Expr (SBin (SBin (SymInt 2) Mul (SymVar Int "i")) Add (SymInt 4))

51. (visitNode -> End -> method returns): Returning: ER_Expr (SBin (SBin (SymInt 2) Mul (SymVar Int "i")) Add (SymInt 4))
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "boo21_3_i_1",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarAssignments,SVarAssignments [("i",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 2}})]),(VarName "i",SBin (SymVar Int "i") Add (SymInt 2)),(Return,SBin (SBin (SymInt 2) Mul (SymVar Int "i")) Add (SymInt 4))], pc = []}