...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Int) "boo28_4_m" []

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: boo28_4_m

3. (visitNode -> Entry -> method with no args): Returning: ()

4. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "boo28_4_m",SMethodType Int)], pc = []})
...
172. actual: boo28_4 ==> (visitSymExpr -> SBin): Returning: ER_Expr (SBool False)
...
183. actual: boo28_4 ==> Next symExpr (VarBindings ==> SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])) in Method Call: boo28_4

184. actual: boo28_4 ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

185. actual: boo28_4 ==> (visitSymExpr -> SVarBindings): handling SymExpr: SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])

186. actual: boo28_4 ==> (visitSymExpr -> SVarBindings): Modifying State: (VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})]))

187. actual: boo28_4 ==> (visitSymExpr -> SVarBindings): Returning: ER_SymStateMapEntry {er_key = VarBindings, er_val = SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])}

188. actual: boo28_4 ==> Next symExpr (VarAssignments ==> SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]) in Method Call: boo28_4

189. actual: boo28_4 ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

190. actual: boo28_4 ==> (visitSymExpr -> SVarAssignments): handling SymExpr: SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]

191. actual: boo28_4 ==> (visitSymExpr -> SVarAssignments): Modifying State: (VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})])

192. actual: boo28_4 ==> (visitSymExpr -> SVarAssignments): Returning: ER_SymStateMapEntry {er_key = VarAssignments, er_val = SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]}
...
200. actual: boo28_4 ==> Next symExpr (VarName "x" ==> SymInt 2) in Method Call: boo28_4

201. actual: boo28_4 ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

202. actual: boo28_4 ==> (visitSymExpr -> SymInt): handling SymExpr: SymInt 2

203. actual: boo28_4 ==> (visitSymExpr -> SymInt): Modifying State: (VarName "x",SymInt 2)

204. actual: boo28_4 ==> (visitSymExpr -> SymInt): Returning: ER_SymStateMapEntry {er_key = VarName "x", er_val = SymInt 2}

205. actual: boo28_4 ==> (visitSymExpr -> SIte -> resolved condition is False): Modifying State: (<no key>,<whole state is updated>: SymState {env = fromList [(MethodName "boo28_4",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]),(VarName "i",SymInt (-10)),(VarName "x",SymInt 2)], pc = []})

206. actual: boo28_4 ==> Next symExpr (Return ==> SymInt 5) in Method Call: boo28_4

207. actual: boo28_4 ==> >>>>>>>>>> visitSymExpr <<<<<<<<<<

208. actual: boo28_4 ==> (visitSymExpr -> SymInt): handling SymExpr: SymInt 5

209. actual: boo28_4 ==> (visitSymExpr -> SymInt): Modifying State: (Return,SymInt 5)

210. actual: boo28_4 ==> (visitSymExpr -> SymInt): Returning: ER_SymStateMapEntry {er_key = Return, er_val = SymInt 5}

211. Method Call actual SymState: SymState {env = fromList [(MethodName "boo28_4",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]),(VarName "i",SymInt (-10)),(VarName "x",SymInt 2),(Return,SymInt 5)], pc = []}

212. (visitExpr -> FunCallExpr -> with parameters): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo28_4",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]),(VarName "i",SymInt (-10)),(VarName "x",SymInt 2),(Return,SymInt 5)], pc = []})

213. (visitStmt -> ReturnStmt -> method with args): Modifying State: (return,SymInt 5)

214. (visitStmt -> ReturnStmt): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo28_4",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]),(VarName "i",SymInt (-10)),(VarName "x",SymInt 2),(Return,SymInt 5)], pc = []})

215. (visitNode -> End -> method returns): Returning: ER_FunCall (SymState {env = fromList [(MethodName "boo28_4",SMethodType Int),(FormalParms,SFormalParms ["i"]),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 4}}),("x",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 2, branchEnd = 6}})]),(VarName "i",SymInt (-10)),(VarName "x",SymInt 2),(Return,SymInt 5)], pc = []})
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "boo28_4_m",SMethodType Int),(Return,SymInt 5)], pc = []}