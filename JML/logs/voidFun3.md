...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Void) "voidFun3" []

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: voidFun3

3. (visitNode -> Entry -> method with no args): Returning: ()

4. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "voidFun3",SMethodType Void)], pc = []})
...
12. (visitNode -> Node -> Statement): Adding Var Binding: ("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 6}})
...
21. (visitNode -> Node -> Statement): Adding Var Binding: ("y",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 6}})
...
37. (visitNode -> Node -> Statement): Adding Var Assignment: ("x",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 6}})
...
53. (visitNode -> Node -> Statement): Adding Var Assignment: ("y",Node_Coor {varDeclAt = 4, varFrame = SR {branchStart = 0, branchEnd = 6}})
...
85. (visitNode -> Node -> Statement): Adding Var Binding: ("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})

86. (visitNode -> Node -> Statement): Adding Var Assignment: ("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})

87. (visitNode -> Node -> Statement): Returning: ER_SymStateMapEntry {er_key = VarName "z", er_val = SymString "1 is one"}

88. Next Node: End {id = 6, parent = 0, mExpr = Nothing}

>>>>>>>>>> visitNode <<<<<<<<<<

89. (visitNode -> End): Method End

90. (visitNode -> End -> return nothing): Void

91. (visitNode -> End -> void method): Returning: ER_State (SymState {env = fromList [(MethodName "voidFun3",SMethodType Void),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 6}}),("y",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 6}}),("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 6}}),("y",Node_Coor {varDeclAt = 4, varFrame = SR {branchStart = 0, branchEnd = 6}}),("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})]),(VarName "x",SymInt 1),(VarName "y",SymString "is one"),(VarName "z",SymString "1 is one")], pc = []})
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "voidFun3",SMethodType Void),(VarBindings,SVarBindings (fromList [("x",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 6}}),("y",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 6}}),("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})])),(VarAssignments,SVarAssignments [("x",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 6}}),("y",Node_Coor {varDeclAt = 4, varFrame = SR {branchStart = 0, branchEnd = 6}}),("z",Node_Coor {varDeclAt = 5, varFrame = SR {branchStart = 0, branchEnd = 6}})]),(VarName "x",SymInt 1),(VarName "y",SymString "is one"),(VarName "z",SymString "1 is one")], pc = []}