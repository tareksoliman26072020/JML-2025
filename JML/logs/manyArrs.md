...
===Begin Logs===
================
1. Next Node: Entry (BuiltInType Void) "manyArrs" []

>>>>>>>>>> visitNode <<<<<<<<<<

2. (visitNode -> Entry): Method Start: manyArrs

3. (visitNode -> Entry -> method with no args): Returning: ()

4. (visitNode -> Entry -> method has args): Returning: ER_State (SymState {env = fromList [(MethodName "manyArrs",SMethodType Void)], pc = []})
...
21. (visitNode -> Node -> Statement): Adding Var Binding: ("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}})

22. (visitNode -> Node -> Statement): Adding Var Assignment: ("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}})
...
41. (visitNode -> Node -> Statement): Adding Var Assignment: ("numbers",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 5}})
...
60. (visitNode -> Node -> Statement): Adding Var Assignment: ("numbers",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 5}})

61. (visitNode -> Node -> Statement): Returning: ER_SymStateMapEntry {er_key = VarName "numbers", er_val = SymInt 5}

62. Next Node: Node {id = 4, nodeData = Statement (FunCallStmt {funCall = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "println"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "numbers"}]}}), parent = 0}

>>>>>>>>>> visitNode <<<<<<<<<<

63. (visitNode -> case nodeData of Node -> Statement): Method Statement: FunCallStmt {funCall = FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "println"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "numbers"}]}}

64. (visitExpr -> FunCallExpr): handling expression: FunCallExpr {funName = VarExpr {varType = Nothing, varObj = [], varName = "println"}, funArgs = [VarExpr {varType = Nothing, varObj = [], varName = "numbers"}]}

65. (visitExpr ==> FunCallExpr): Processing Predefined FunCall: VarExpr {varType = Nothing, varObj = [], varName = "println"}[VarExpr {varType = Nothing, varObj = [], varName = "numbers"}]
...
69. (visitExpr ==> FunCallExpr): Returning: ER_Print "[99, 5]\n"

70. (visitStmt -> FunCallStmt): Modifying State: (SActions,[99, 5]
)

71. (visitStmt -> FunCallStmt): Returning: ER_Print "[99, 5]\n"

72. (visitNode -> Node -> Statement): Returning: ER_Print "[99, 5]\n"

73. Next Node: End {id = 5, parent = 0, mExpr = Nothing}
...
76. (visitNode -> End -> void method): Returning: ER_State (SymState {env = fromList [(MethodName "manyArrs",SMethodType Void),(VarBindings,SVarBindings (fromList [("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}})])),(VarAssignments,SVarAssignments [("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("numbers",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 5}}),("numbers",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 5}})]),(VarName "numbers",SymArray (Just (Array Int)) (Just 2) [SymInt 99,SymInt 5]),(Actions,SActions ["[99, 5]\n"])], pc = []})
==============
===End Logs===
==============
...
SymState:
SymState {env = fromList [(MethodName "manyArrs",SMethodType Void),(VarBindings,SVarBindings (fromList [("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}})])),(VarAssignments,SVarAssignments [("numbers",Node_Coor {varDeclAt = 1, varFrame = SR {branchStart = 0, branchEnd = 5}}),("numbers",Node_Coor {varDeclAt = 2, varFrame = SR {branchStart = 0, branchEnd = 5}}),("numbers",Node_Coor {varDeclAt = 3, varFrame = SR {branchStart = 0, branchEnd = 5}})]),(VarName "numbers",SymArray (Just (Array Int)) (Just 2) [SymInt 99,SymInt 5]),(Actions,SActions ["[99, 5]\n"])], pc = []}