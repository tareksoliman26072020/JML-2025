...
{-
newType: Int,
er: ER_SymStateMapEntry (VarName "y") (SymVar UnknownNumSymType "y")
 -}
            ...
            ma2 <- Map.alterF (\case
                  ...
                  Just oldSymExpr ->
                    ...
                    in if newType2 == toSymType2 oldSymExpr
                         ...
                         tellNextLog
                           $ Log.UpdateVariable (vn,show oldSymExpr,show newSymExpr) loc
...
existsIn vn symExpr = case symExpr of
  ...
  --SArrayIndexAccess (SYT.Array SYT.Int) "a" (SYT.SymVar SYT.Int "i" [])
  SArrayIndexAccess _ vn2 _ -> vn == vn2
  SObjAcc _ -> False
  SymNull _ -> False
