...
target name = case lookup name allTargets of
  Nothing -> error $ "testing ==> JML ==> target ==> funname does not exist: " ++ name
...
allTargets = [
  ...
  ("boo24",boo24), ("boo24_2",boo24_2),
  ("exceptionFun",exceptionFun),
  ("boo25",boo25),
  ("boo26_2",boo26_2),
  ("boo27",boo27), ("boo27_2",boo27_2),
  ("boo28",boo28), ("boo282",boo282), ("boo283",boo283), ("boo28_p",boo28_p),
  ("boo28_m",boo28_m), ("boo28_2",boo28_2), ("boo28_2_1",boo28_2_1), ("boo28_4",boo28_4),
  ("boo28_4_1",boo28_4_1), ("boo28_4_2",boo28_4_2), ("boo28_4_p",boo28_4_p),
...
boo33_5 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = ["z"],
      vars = [JMLVar Double_Type "x" `JMLEquals` JMLDouble 1.1
             ,JMLVar Unknown_Type "z" `JMLEquals` JMLVar Unknown_Type "t"],
      hasSideEffect = False,
      ensures = [JMLResult $ JMLDouble 1.1
                ,JMLVar Unknown_Type "z" `JMLEquals` JMLVar Unknown_Type "t"]
    }
...
boo33_6 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = ["z"],
      vars = [
        JMLVar Double_Type "x" `JMLEquals` JMLDouble 1.1,
...
boo33_5_3 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = ["z"],
      vars = [
        JMLVar String_Type "str" `JMLEquals` JMLBin (JMLOld (JMLVar String_Type "str")) Add (JMLString "1"),
        JMLVar Double_Type "x" `JMLEquals` JMLDouble 1.1,
...
boo21_3_i = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = [],
      vars = [
        JMLVar Int_Type "i" `JMLEquals` JMLBin (JMLOld (JMLVar Int_Type "i")) Add (JMLInt 2)],
      hasSideEffect = False,
      ensures = [
...
boo21_3_i_2 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "i" `JMLEquals` JMLBin (JMLOld (JMLVar Int_Type "i")) Add (JMLInt 2),
        JMLVar Int_Type "x" `JMLEquals` JMLBin (JMLBin (JMLInt 2) Mul (JMLOld (JMLVar Int_Type "i"))) Add (JMLInt 9)],
      hasSideEffect = False,
      ensures = [
        JMLResult $ JMLBin (JMLBin (JMLInt 2)
                                   Mul
...
boo22_2_i_2 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = [],
      vars = [
        JMLVar Int_Type "i" `JMLEquals` JMLInt 9,
        JMLVar Int_Type "j" `JMLEquals` JMLInt 6,
        JMLVar Int_Type "x" `JMLEquals` JMLInt 18
      ],
      hasSideEffect = False,
...
boo23_3_i_2 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = [],
      vars = [
        JMLVar Int_Type "i" `JMLEquals` JMLInt 4,
        JMLVar Int_Type "x" `JMLEquals` JMLInt 11
      ],
      hasSideEffect = False,
...
boo24_2 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ ExceptionalBehavior {
      ...
      signals = "Exception",
      assignable = [],
      vars = [JMLVar Int_Type "x" `JMLEquals` JMLException Int_Type "Exception" "meow"],
      hasSideEffect = True,
      ensures = []
    }
  ]
...
boo27 = Method {
  ...
  jmlSpecifications = [
     ...
     MethodSpecification $ NormalBehavior {
      ...
      hasSideEffect = False,
      ensures = [JMLResult $ JMLBin (JMLInt (-1)) Mul (JMLVar Int_Type "i")]
    }
  ]
}
...
boo28_6_6_2 = Method {
  ...
  jmlSpecifications = [
     ...
     MethodSpecification $ NormalBehavior {
      ...
      vars = [JMLVar Int_Type "x" `JMLEquals` JMLInt 2],
      hasSideEffect = False,
      ensures = [JMLResult $ JMLBin (JMLVar Int_Type "i") Add (JMLInt 2)]
    }
  ]
}
...
boo28_6_6_3 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      hasSideEffect = False,
      ensures = [
        JMLResult (JMLBin (JMLVar Int_Type "i") Add (JMLInt 0)),
        JMLVar Bool_Type "y" `JMLEquals` JMLBool True
      ]
    },
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "x" `JMLEquals` JMLInt 2,
        JMLVar Bool_Type "y" `JMLEquals` JMLBool False
      ],
      hasSideEffect = False,
      ensures = [
        JMLResult (JMLBin (JMLVar Int_Type "i") Add (JMLInt 2)),
...
boo28_6_6_4 = Method {
  ...
  jmlSpecifications = [
     ...
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "x" `JMLEquals` JMLInt 2,
        JMLVar Int_Type "z" `JMLEquals` JMLInt 9
      ],
      hasSideEffect = False,
      ensures = [JMLResult (JMLInt 2)]
    }
...
ifFun = Method {
  ...
  jmlSpecifications = [
     ...
     MethodSpecification $ NormalBehavior {
      ...
      assignable = [],
      vars = [
        JMLVar Int_Type "m" `JMLEquals` JMLInt 0,
        JMLVar Int_Type "res" `JMLEquals` JMLInt 0,
        JMLVar Int_Type "x" `JMLEquals` JMLInt 1
      ],
      hasSideEffect = False,
...
ifFun2 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "m" `JMLEquals` JMLBin (JMLInt 2) Mul (JMLVar Int_Type "n"),
        JMLVar Int_Type "res" `JMLEquals` JMLBin (JMLVar Int_Type "y") Add (JMLVar Int_Type "n"),
        JMLVar Int_Type "x" `JMLEquals` JMLInt 1
      ],
      hasSideEffect = False,
     ...
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "m" `JMLEquals` JMLInt 0,
        JMLVar Int_Type "res" `JMLEquals` JMLVar Int_Type "y",
        JMLVar Int_Type "x" `JMLEquals` JMLInt 1
      ],
      hasSideEffect = False,
      ensures = [JMLResult $ JMLBin (JMLVar Int_Type "y") Add (JMLInt 1)]
    }
  ]
}
...
ifFun2Call = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [],
      hasSideEffect = False,
      ensures = [JMLResult $ JMLBin (JMLVar Int_Type "y") Add (JMLInt 11)]
    }
  ]
}
...
ifFun4 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      hasSideEffect = False,
      ensures = [
        JMLResult (JMLBin (JMLOld (JMLVar Int_Type "y")) Add (JMLVar Int_Type "n")),
        JMLVar Int_Type "y" `JMLEquals` JMLBin (JMLOld (JMLVar Int_Type "y")) Add (JMLVar Int_Type "n")
      ]
    },
     MethodSpecification $ NormalBehavior {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        ...
        JMLVar String_Type "w" `JMLEquals` JMLOld (JMLVar String_Type "w")
      ],
      hasSideEffect = False,
      ensures = [
        JMLResult JMLVoid,
     ...
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar String_Type "s" `JMLEquals` JMLString "something",
        JMLVar String_Type "v" `JMLEquals` JMLOld (JMLVar String_Type "v"),
        JMLVar String_Type "w" `JMLEquals` JMLString "bye"
      ],
      hasSideEffect = False,
      ensures = [
        JMLResult JMLVoid,
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar String_Type "s" `JMLEquals` JMLString "something",
        JMLVar String_Type "v" `JMLEquals` JMLString "hi",
        JMLVar String_Type "w" `JMLEquals` JMLVar String_Type "w",
        JMLVar Int_Type "n" `JMLEquals` JMLVar Int_Type "t"
      ],
      hasSideEffect = False,
      ensures = [
        JMLResult JMLVoid,
     ...
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar String_Type "s" `JMLEquals` JMLString "something",
        JMLVar String_Type "v" `JMLEquals` JMLVar String_Type "v",
        JMLVar String_Type "w" `JMLEquals` JMLString "bye",
        JMLVar Int_Type "n" `JMLEquals` JMLVar Int_Type "t"
      ],
      hasSideEffect = False,
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        ...
        JMLVar String_Type "w" `JMLEquals` JMLOld (JMLVar String_Type "w"),
        JMLVar Int_Type "z" `JMLEquals` JMLInt 3
      ],
      hasSideEffect = False,
      ensures = [
        JMLResult JMLVoid,
...
ifFun10 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "res" `JMLEquals` JMLInt 0,
        JMLVar Unknown_Type "t" `JMLEquals` JMLVar Unknown_Type "i",
...
ifFun13 = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = ["s","v"],
      vars = [
        JMLVar String_Type "s" `JMLEquals` JMLBin (JMLString "something") Add (SymFun ToString (JMLVar Unknown_Type "n")),
        JMLVar String_Type "v" `JMLEquals` JMLString "hi",
        JMLVar String_Type "w" `JMLEquals` JMLOld (JMLVar String_Type "w")
      ],
      hasSideEffect = False,
...
succFun = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      assignable = [],
      vars = [
        JMLVar Int_Type "i" `JMLEquals` JMLBin (JMLOld (JMLVar Int_Type "i")) Add (JMLInt 1)
      ],
      hasSideEffect = False,
      ensures = [JMLResult JMLVoid]
    }
...
callSuccFun = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [],
      hasSideEffect = False,
      ensures = [JMLResult (JMLVar Int_Type "n")]
    }
  ]
}
...
isEmpty = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [],
      hasSideEffect = False,
      ensures = [JMLResult $ JMLBin (JMLObjAcc ["arr","length"]) Eq (JMLInt 0)]
    }
  ]
}
...
callIsEmpty = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      vars = [],
      hasSideEffect = False, 
      ensures = [JMLResult (JMLBool True)]
    }
  ]
}
...
arrayBoolean = Method {
  ...
  jmlSpecifications = [
     MethodSpecification $ NormalBehavior {
      ...
      hasSideEffect = False,
      ensures = [
        JMLResult $ JMLBin (JMLBin (JMLVar (Array_Type Int_Type) "arr")
                                   Eq
                                   (JMLNull (Array_Type Int_Type)))
                           Or
                           (JMLBin (JMLObjAcc ["arr","length"]) Le (JMLInt 1))
      ]
    }
  ]
}
...
idByLoopStride3 :: Method
idByLoopStride3 = Method {
  name = "idByLoopStride3",
  jmlSpecifications = [
    LoopSpecification $ LoopInvariants {
      loopScopeRange = SR {branchStart = 2, branchEnd = 4},
      loopClauses = [
    ...
    MethodSpecification $ NormalBehavior {
      ...
      vars = [
        JMLVar Int_Type "i"
          `JMLEquals`
            (JMLBin (JMLInt 0) Lt (JMLVar Int_Type "n")
               `JMLImplies`
                 JMLRange "i" (JMLVar Int_Type "n") (JMLBin (JMLVar Int_Type "n") Add (JMLInt 2))),
        JMLVar Int_Type "i"
          `JMLEquals`
            (JMLBin (JMLInt 0) Ge (JMLVar Int_Type "n") `JMLImplies` JMLInt 0)
      ],
        ...
        JMLResult $
          JMLBin (JMLInt 0) Lt (JMLVar Int_Type "n")
            `JMLImplies`
              JMLRange "i" (JMLVar Int_Type "n") (JMLBin (JMLVar Int_Type "n") Add (JMLInt 2)),
        JMLResult $
          JMLBin (JMLInt 0) Ge (JMLVar Int_Type "n")
            `JMLImplies`
              JMLInt 0
      ]
    }
